...
SELECT *  -- Explicit Column Names Can Be Specified Instead of The * Wildcard Character
INTO CustCopy
FROM Customers
-- NOTE: SELECT Statement Creates a New Table Named 'CustCopy' (Created On-the-fly) & Copies The Entire Contents Into It
